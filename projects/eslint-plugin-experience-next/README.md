...
| [prefer-loose-null-check](https://github.com/taiga-family/toolkit/tree/main/projects/eslint-plugin-experience-next/docs/prefer-loose-null-check.md)                                                 | Prefer `x != null` over explicit strict comparisons against `null` or `undefined`                  | ✅  | 🔧  |     |
