...
export const rule = createRule({
    ...
    rule: {
        create(context: Rule.RuleContext) {
            ...
            return {
                Element(rawNode: unknown) {
                    ...
                    if (
                        firstAttr.sourceSpan.start.line ===
                        node.startSourceSpan.start.line
                    ) {
                        context.report({
                    ...
                    for (const [index, attr] of attrs.entries()) {
                        ...
                        if (
                            previousAttr.sourceSpan.end.line ===
        ...
        meta: {
            docs: {
                description: 'Enforce newline-separated attributes for multiline tags',
            },
            fixable: 'code',
            messages: {
